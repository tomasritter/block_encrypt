...
pub type Aesni128Cbc = CipherImpl<Aesni128, Cbc<Aesni128, ZeroPadding>>;
pub type Aesni128Ecb = CipherImpl<Aesni128, Ecb<Aesni128, ZeroPadding>>;
pub type Aesni128Pcbc = CipherImpl<Aesni128, Pcbc<Aesni128, ZeroPadding>>;
pub type Aesni128Xts = XTSCipherImpl<Aesni128>;

pub type Aesni192Cbc = CipherImpl<Aesni192, Cbc<Aesni192, ZeroPadding>>;
pub type Aesni192Ecb = CipherImpl<Aesni192, Ecb<Aesni192, ZeroPadding>>;
pub type Aesni192Pcbc = CipherImpl<Aesni192, Pcbc<Aesni192, ZeroPadding>>;
pub type Aesni192Xts = XTSCipherImpl<Aesni192>;

pub type Aesni256Cbc = CipherImpl<Aesni256, Cbc<Aesni256, ZeroPadding>>;
pub type Aesni256Ecb = CipherImpl<Aesni256, Ecb<Aesni256, ZeroPadding>>;
pub type Aesni256Pcbc = CipherImpl<Aesni256, Pcbc<Aesni256, ZeroPadding>>;
